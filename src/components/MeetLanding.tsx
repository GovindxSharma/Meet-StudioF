            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 relative">
              <div className="relative w-full sm:w-auto">
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-6 py-3.5 rounded-2xl shadow-lg shadow-indigo-600/25 transition-all text-sm whitespace-nowrap cursor-pointer"
                >
                ...
                {showDropdown && (
                  <div className="absolute left-0 top-14 w-64 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3.5 py-3 text-xs font-medium text-slate-300 hover:text-white hover:bg-slate-800 rounded-xl transition-all text-left cursor-pointer"
                    >
              ...
              <form onSubmit={onJoinWithCode} className="flex-1 flex items-center gap-2 w-full">
                ...
                <button
                  ...
                  className="bg-slate-800 hover:bg-slate-700 disabled:opacity-40 text-indigo-400 font-semibold px-5 py-3.5 rounded-2xl transition-all text-sm disabled:cursor-not-allowed cursor-pointer"
                >
                  Join
                </button>
              </form>
          ...
          {copiedLink && (
            <div className="p-4 bg-emerald-950/60 border border-emerald-500/40 rounded-2xl flex items-center justify-between gap-4 max-w-lg text-xs text-emerald-200 animate-in fade-in duration-300">
              <div className="flex items-center gap-2 overflow-hidden">
                ...
                <span className="truncate">Here's your host link: <strong className="text-white">{copiedLink}</strong></span>
              </div>
